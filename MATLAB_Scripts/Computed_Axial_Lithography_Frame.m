...
%START 18/02/2019
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Computed_Axial_Lithography(file,output_directory,slice_height,cross_section_resolution,output_image_resolution,output_image_height,output_image_width)
...
for i = 1:length(movelist)
    ...
    waitbar(i/h,f,sprintf('Please wait.. %.2f %% Complete',(i/h)*100)); 
    drawnow;
...
for output_loop = 1:dimensions_of_image(3)
  ...
  waitbar(output_loop/(dimensions_of_image(3)),f,sprintf('Writting Files.. %.2f %% Complete',100*output_loop/(dimensions_of_image(3)))); 
    ...
    baseFileName = sprintf('Reconstructed_Image_%.2f°.png',(output_loop-1)*angle_frequency);
